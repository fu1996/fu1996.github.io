...
3. `21 年 3 月，因疫情等各种原因，辞职回老家，随后在郑州找到喜欢的工作，尽情发挥下去`

> 我的 `2019 ——> 2023`的工作之旅。生命不息，鼓捣不止，打好基础，修好内功。
...
- 从**21年3月**至今，在 Gitee 的私有化 CICD 域从事 Devops 的相关工作，负责 toD 平台前端的搭建，**逐步从无名小卒成长为前端leader**，也从郑州分部调整到北京总部，期间也学习到了很多 Devops 相关的知识，也巩固了之前搞 Python 时候的后端相关知识。直到**2023年12月18日，在 Gitee 正式离职**，感谢和 Gitee 一起成长的 1000 多天。
![gitee](./gitee_logo.png)
![gitee](./gitee.jpg)

## 大模型时代：可以了解和学习到更多大模型相关的知识啦

> 大学学了2年某🐴的Python就业班课程，在毕业后，从事了一年 Python Odoo12 后端，在 Devops 领域又干了三年前端，现在在 **医疗大模型** 公司 **水木分子** 从事全栈开发，这次可以学习到很多大模型相关知识了，哈哈，人生变得越来越有意思了。

- 2023 年是大模型爆发的一年，在 Gitee 工作的时候，偶然间我发现了GPT的强大，并在公司内部逐步的将大模型和飞书结合起来，大家可以通过飞书直接和大模型沟通，大幅度提高工作效率，节约了一部分查找资料的时间。至此，也对大模型埋下了深深的好奇心，作为一个程序员，很想去搞懂其内部原理。知其然，知其所以然，才能更好的去使用它。
- 在2023年 12 月 中旬，从 Gitee 离职后，正式加入 **水木分子** 从事全栈开发，继续一步一步的成长起来吧。
